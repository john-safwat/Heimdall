...
FirebaseEnglishErrorHandler injectFirebaseEnglishErrorHandler() {
  return FirebaseEnglishErrorHandler.getInstance();
}

// the object
class FirebaseEnglishErrorHandler {

  FirebaseEnglishErrorHandler._();
  static FirebaseEnglishErrorHandler? instance;
  static getInstance(){
    return instance??= FirebaseEnglishErrorHandler._();
  }
